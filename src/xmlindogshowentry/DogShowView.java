	...
	public void createPartControl(Composite parent) {
	    ...
	    //set Title
	      ...
	      //Enter
	       ...
	       enter.addSelectionListener(new SelectionAdapter() {
	          ...
	          public void widgetSelected(SelectionEvent event) {
				...
				try {
					contextObj = JAXBContext.newInstance(DogShowEntryModel.class);
	        	    ...
	        	    marshallerObj.marshal(dse, new FileOutputStream("C:\\Users\\PC\\eclipse-workspace3\\XmlInDogShowEntry\\dogShowEntry.xml"));  
	     ...
	     //Read
	       ...
	       try {
	    	   File file = new File("C:\\Users\\PC\\eclipse-workspace3\\XmlInDogShowEntry\\dogShowEntry.xml");    
	            JAXBContext jaxbContext = JAXBContext.newInstance(DogShowEntryModel.class);    
	         
	            Unmarshaller jaxbUnmarshaller = jaxbContext.createUnmarshaller();    
	            DogShowEntryModel dog=(DogShowEntryModel) jaxbUnmarshaller.unmarshal(file); 
